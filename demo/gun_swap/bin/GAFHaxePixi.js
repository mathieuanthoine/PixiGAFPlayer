...
com_github_haxePixiGAF_core_ZipToGAFAssetConverter.prototype = $extend(PIXI.utils.EventEmitter.prototype,{
	convert: function(data,defaultScale,defaultContentScaleFactor) {
		...
		if((data instanceof Array) && data.__enum__ == null) {
			...
			haxe_Log.trace("ERROR",{ fileName : "ZipToGAFAssetConverter.hx", lineNumber : 164, className : "com.github.haxePixiGAF.core.ZipToGAFAssetConverter", methodName : "convert"});
		}
	}
	,reset: function() {
	...
	,parseVector: function(pData) {
		...
		while(_g1 < length) {
			...
			case ".gaf":
				...
				break;
			case ".png":
				haxe_Log.trace("TODO PNG",{ fileName : "ZipToGAFAssetConverter.hx", lineNumber : 297, className : "com.github.haxePixiGAF.core.ZipToGAFAssetConverter", methodName : "parseVector"});
				break;
			}
		}
		this.convertConfig();
...
com_github_haxePixiGAF_data_converters_BinGAFAssetConfigConverter.prototype = $extend(PIXI.utils.EventEmitter.prototype,{
	...
	,readNextTag: function() {
		...
		case 5:
			...
			break;
		case 6:
			haxe_Log.trace("TODO TAG_DEFINE_SEQUENCES",{ fileName : "BinGAFAssetConfigConverter.hx", lineNumber : 227, className : "com.github.haxePixiGAF.data.converters.BinGAFAssetConfigConverter", methodName : "readNextTag"});
			break;
		case 7:
			haxe_Log.trace("TODO TAG_DEFINE_TEXT_FIELDS",{ fileName : "BinGAFAssetConfigConverter.hx", lineNumber : 231, className : "com.github.haxePixiGAF.data.converters.BinGAFAssetConfigConverter", methodName : "readNextTag"});
			break;
		case 8:
			this.readTextureAtlasConfig(tagID);
			break;
		...
		case 13:
			...
			break;
		case 14:
			haxe_Log.trace("TODO TAG_DEFINE_SOUNDS",{ fileName : "BinGAFAssetConfigConverter.hx", lineNumber : 235, className : "com.github.haxePixiGAF.data.converters.BinGAFAssetConfigConverter", methodName : "readNextTag"});
		...
		case 15:
			...
			break;
		default:
			haxe_Log.trace("Unsupported tag found, check for playback library updates",{ fileName : "BinGAFAssetConfigConverter.hx", lineNumber : 258, className : "com.github.haxePixiGAF.data.converters.BinGAFAssetConfigConverter", methodName : "readNextTag"});
			var _g1 = this._bytes;
						...
						if(hasEffect) {
							...
							while(_g5 < filterLength) {
								...
								case 6:
									...
									break;
								default:
									haxe_Log.trace("Unsupported filter in animation",{ fileName : "BinGAFAssetConfigConverter.hx", lineNumber : 750, className : "com.github.haxePixiGAF.data.converters.BinGAFAssetConfigConverter", methodName : "readAnimationFrames"});
								}
...
com_github_haxePixiGAF_display_GAFMovieClip.__interfaces__ = [com_github_haxePixiGAF_display_IMaxSize,com_github_haxePixiGAF_display_IGAFDisplayObject,com_github_haxePixiGAF_display_IAnimatable];
...
com_github_haxePixiGAF_display_GAFMovieClip.__super__ = PIXI.Container;
com_github_haxePixiGAF_display_GAFMovieClip.prototype = $extend(PIXI.Container.prototype,{
	...
	,showMaskByID: function(id) {
		...
		if(maskObject != null && stencilMaskObject != null) {
			...
			haxe_Log.trace("WARNING:mask object is missing. It might be disposed.",{ fileName : "GAFMovieClip.hx", lineNumber : 210, className : "com.github.haxePixiGAF.display.GAFMovieClip", methodName : "showMaskByID"});
		}
	}
	,hideMaskByID: function(id) {
		...
		if(stencilMaskObject != null) {
			...
			haxe_Log.trace("WARNING:mask object is missing. It might be disposed.",{ fileName : "GAFMovieClip.hx", lineNumber : 236, className : "com.github.haxePixiGAF.display.GAFMovieClip", methodName : "hideMaskByID"});
		}
	}
	...
	,advanceTime: function(passedTime) {
		...
		this._previousTime = passedTime;
		if(this._disposed) {
			haxe_Log.trace("WARNING:GAFMovieClip is disposed but is not removed from the Juggler",{ fileName : "GAFMovieClip.hx", lineNumber : 392, className : "com.github.haxePixiGAF.display.GAFMovieClip", methodName : "advanceTime"});
			return;
	...
	,showBounds: function(value) {
		if(this._config.get_bounds() != null) {
			haxe_Log.trace("TODO showBounds",{ fileName : "GAFMovieClip.hx", lineNumber : 449, className : "com.github.haxePixiGAF.display.GAFMovieClip", methodName : "showBounds"});
		}
	}
	,setFilterConfig: function(value,scale) {
		if(scale == null) {
		...
		haxe_Log.trace("TODO: setFilterConfig",{ fileName : "GAFMovieClip.hx", lineNumber : 472, className : "com.github.haxePixiGAF.display.GAFMovieClip", methodName : "setFilterConfig"});
	}
	,invalidateOrientation: function() {
	}
	,copy: function() {
		...
		if(actions != null) {
			...
			while(_g1 < _g) {
				...
				case 3:
					...
					break;
				case 4:
					haxe_Log.trace("CFrameAction.DISPATCH_EVENT",{ fileName : "GAFMovieClip.hx", lineNumber : 685, className : "com.github.haxePixiGAF.display.GAFMovieClip", methodName : "runActions"});
	...
	,checkAndSetCurrentFrame: function(frame) {
		if(_$UInt_UInt_$Impl_$.gt(js_Boot.__cast(frame , Int),0)) {
		...
		if(frames.length > this._currentFrame) {
			...
			while(i < l) {
				...
				if(displayObject != null) {
					objectPivotMatrix = com_github_haxePixiGAF_display_GAFMovieClip.getTransformMatrix(displayObject,com_github_haxePixiGAF_display_GAFMovieClip.HELPER_MATRIX);
					...
					if(!(__map_reserved[key1] != null?animationObjectsDictionary.getReserved(key1):animationObjectsDictionary.h[key1]).get_mask()) {
						if(instance.get_maskID() != "") {
							haxe_Log.trace("TODO Mask support",{ fileName : "GAFMovieClip.hx", lineNumber : 841, className : "com.github.haxePixiGAF.display.GAFMovieClip", methodName : "draw"});
							this.renderDebug(mc,instance,true);
							var key2 = instance.get_maskID();
							var tmp = __map_reserved[key2];
						} else {
						...
						var maskObject = __map_reserved[key3] != null?_this1.getReserved(key3):_this1.h[key3];
						if(maskObject != null) {
							var maskInstance = frameConfig.getInstanceByID(instance.get_id());
							if(maskInstance != null) {
								com_github_haxePixiGAF_display_GAFMovieClip.getTransformMatrix(maskObject,com_github_haxePixiGAF_display_GAFMovieClip.HELPER_MATRIX);
								maskInstance.applyTransformMatrix(maskObject.get_transformationMatrix(),com_github_haxePixiGAF_display_GAFMovieClip.HELPER_MATRIX,this._scale);
	...
	,renderDebug: function(mc,instance,masked) {
		if(com_github_haxePixiGAF_utils_DebugUtility.RENDERING_DEBUG && mc != null) {
			haxe_Log.trace("TODO renderDebug",{ fileName : "GAFMovieClip.hx", lineNumber : 928, className : "com.github.haxePixiGAF.display.GAFMovieClip", methodName : "renderDebug"});
		}
	}
	,addDebugRegions: function() {
		haxe_Log.trace("TODO addDebugRegions",{ fileName : "GAFMovieClip.hx", lineNumber : 959, className : "com.github.haxePixiGAF.display.GAFMovieClip", methodName : "addDebugRegions"});
	}
	,reset: function() {
	...
	,initialize: function(textureAtlas,gafAsset) {
		...
		while(tmp.hasNext()) {
			...
			case "textField":
				haxe_Log.trace("TODO initialize GAFTextField",{ fileName : "GAFMovieClip.hx", lineNumber : 1033, className : "com.github.haxePixiGAF.display.GAFMovieClip", methodName : "initialize"});
				break;
			case "texture":
				...
				if(js_Boot.__instanceof(texture,com_github_haxePixiGAF_display_GAFScale9Texture) && !animationObjectConfig.get_mask()) {
					haxe_Log.trace("TODO initialize GAFScale9Texture",{ fileName : "GAFMovieClip.hx", lineNumber : 1023, className : "com.github.haxePixiGAF.display.GAFMovieClip", methodName : "initialize"});
				} else {
	...
	,updateBounds: function(bounds) {
		haxe_Log.trace("TODO updateBounds",{ fileName : "GAFMovieClip.hx", lineNumber : 1096, className : "com.github.haxePixiGAF.display.GAFMovieClip", methodName : "updateBounds"});
	}
	,__debugHighlight: function() {
		if(isNaN(this.__debugOriginalAlpha)) {
			this.__debugOriginalAlpha = this.alpha;
	...
	,removeChildAt: function(index) {
		haxe_Log.trace("TODO: removeChildAt",{ fileName : "GAFMovieClip.hx", lineNumber : 1175, className : "com.github.haxePixiGAF.display.GAFMovieClip", methodName : "removeChildAt"});
	...
	,getChildByName: function(name) {
		...
		return PIXI.Container.prototype.getChildByName.call(this,name);
	}
	,destroy: function(options) {
		if(this._disposed) {
			return;
	...
	,get_pivotMatrix: function() {
		com_github_haxePixiGAF_display_GAFMovieClip.HELPER_MATRIX.identity();
		return com_github_haxePixiGAF_display_GAFMovieClip.HELPER_MATRIX;
	}
	,get_transformationMatrix: function() {
		return this.localTransform;
	}
...
var com_github_mathieuanthoine_gaf_Main = function() {
	...
	this.urlsList.push("Test" + "/" + "Test" + ".gaf");
	this.load();
};
...
com_github_mathieuanthoine_gaf_Main.prototype = {
	...
	,onConverted: function(pEvent) {
		this.gafMovieClip = new com_github_haxePixiGAF_display_GAFMovieClip((js_Boot.__cast(pEvent.target , com_github_haxePixiGAF_core_ZipToGAFAssetConverter)).get_gafBundle().getGAFTimeline("Test","rootTimeline"));
...
com_github_haxePixiGAF_display_GAFMovieClip.HELPER_MATRIX = new PIXI.Matrix();
...
com_github_mathieuanthoine_gaf_Main.FILE_NAME = "Test";
