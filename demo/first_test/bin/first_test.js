...
com_github_haxePixiGAF_display_GAFMovieClip.prototype = $extend(PIXI.Container.prototype,{
	...
	,showMaskByID: function(id) {
		...
		if(maskObject != null && stencilMaskObject != null) {
			...
			haxe_Log.trace("WARNING:mask object is missing. It might be disposed.",{ fileName : "GAFMovieClip.hx", lineNumber : 203, className : "com.github.haxePixiGAF.display.GAFMovieClip", methodName : "showMaskByID"});
		}
	}
	,hideMaskByID: function(id) {
		...
		if(stencilMaskObject != null) {
			...
			haxe_Log.trace("WARNING:mask object is missing. It might be disposed.",{ fileName : "GAFMovieClip.hx", lineNumber : 229, className : "com.github.haxePixiGAF.display.GAFMovieClip", methodName : "hideMaskByID"});
		}
	}
	...
	,advanceTime: function(passedTime) {
		...
		this._previousTime = passedTime;
		if(this._disposed) {
			haxe_Log.trace("WARNING:GAFMovieClip is disposed but is still listening requestAnimationFrame",{ fileName : "GAFMovieClip.hx", lineNumber : 385, className : "com.github.haxePixiGAF.display.GAFMovieClip", methodName : "advanceTime"});
			return;
	...
	,showBounds: function(value) {
		if(this._config.get_bounds() != null) {
			haxe_Log.trace("TODO showBounds",{ fileName : "GAFMovieClip.hx", lineNumber : 442, className : "com.github.haxePixiGAF.display.GAFMovieClip", methodName : "showBounds"});
		}
	}
	,setFilterConfig: function(value,scale) {
		if(scale == null) {
		...
		if(actions != null) {
			...
			while(_g1 < _g) {
				...
				case 3:
					...
					break;
				case 4:
					haxe_Log.trace("CFrameAction.DISPATCH_EVENT",{ fileName : "GAFMovieClip.hx", lineNumber : 678, className : "com.github.haxePixiGAF.display.GAFMovieClip", methodName : "runActions"});
	...
	,renderDebug: function(mc,instance,masked) {
		if(com_github_haxePixiGAF_utils_DebugUtility.RENDERING_DEBUG && mc != null) {
			haxe_Log.trace("TODO renderDebug",{ fileName : "GAFMovieClip.hx", lineNumber : 921, className : "com.github.haxePixiGAF.display.GAFMovieClip", methodName : "renderDebug"});
		}
	}
	,addDebugRegions: function() {
		haxe_Log.trace("TODO addDebugRegions",{ fileName : "GAFMovieClip.hx", lineNumber : 952, className : "com.github.haxePixiGAF.display.GAFMovieClip", methodName : "addDebugRegions"});
	}
	,reset: function() {
	...
	,initialize: function(textureAtlas,gafAsset) {
		...
		while(tmp.hasNext()) {
			...
			case "textField":
				haxe_Log.trace("TODO initialize GAFTextField",{ fileName : "GAFMovieClip.hx", lineNumber : 1026, className : "com.github.haxePixiGAF.display.GAFMovieClip", methodName : "initialize"});
				break;
			case "texture":
				...
				if(js_Boot.__instanceof(texture,com_github_haxePixiGAF_display_GAFScale9Texture) && !animationObjectConfig.get_mask()) {
					haxe_Log.trace("TODO initialize GAFScale9Texture",{ fileName : "GAFMovieClip.hx", lineNumber : 1016, className : "com.github.haxePixiGAF.display.GAFMovieClip", methodName : "initialize"});
				} else {
	...
	,updateBounds: function(bounds) {
		haxe_Log.trace("TODO updateBounds",{ fileName : "GAFMovieClip.hx", lineNumber : 1090, className : "com.github.haxePixiGAF.display.GAFMovieClip", methodName : "updateBounds"});
	}
	,__debugHighlight: function() {
		if(isNaN(this.__debugOriginalAlpha)) {
			this.__debugOriginalAlpha = this.alpha;
	...
	,removeChildAt: function(index) {
		haxe_Log.trace("TODO: removeChildAt",{ fileName : "GAFMovieClip.hx", lineNumber : 1169, className : "com.github.haxePixiGAF.display.GAFMovieClip", methodName : "removeChildAt"});
