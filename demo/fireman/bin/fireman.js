...
var com_github_mathieuanthoine_gaf_Main = function() {
	this.renderer = PIXI.autoDetectRenderer(800,480,{ backgroundColor : 16777215});
...
com_github_mathieuanthoine_gaf_Main.prototype = {
	onConverted: function(pEvent) {
		var mc = new com_github_haxePixiGAF_display_GAFMovieClip((js_Boot.__cast(pEvent.target , com_github_haxePixiGAF_core_ZipToGAFAssetConverter)).get_gafBundle().getGAFTimeline("fireman"));
